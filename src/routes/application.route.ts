...
class ApplicationRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.get(`${this.path}/post`, this.applicationsController.getAllApplicationByPostId);
    ...
    this.router.put(
      `${this.path}/:id`,
      validationMiddleware(UpdateStatusApplicationDto, 'body', true),
      this.applicationsController.updateApplication,
    );
